# Video Interface Controller library for driving displays and LCDs

## What is the vic library?
A lightweight, extremly fast and powerful primitive and text rendering C++ library for driving graphic, alpha numeric and seven-segment displays.
If you need a robust and universal library for rendering text and graphics on various displays - VIC is your library!

**vic is beta and still under heavy development. If you have specific questions, do not hesitate to contact me!**
...
- Implement a fast fill algorithm
